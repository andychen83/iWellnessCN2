...
public class RangeBarChart extends BarChart {
   ...
   */
  public RangeBarChart(Context context, boolean isWeight, XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, Type type) {
    super(context ,isWeight,dataset, renderer, type);
  }
