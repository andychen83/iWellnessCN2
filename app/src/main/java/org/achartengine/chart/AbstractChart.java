...
public abstract class AbstractChart implements Serializable {
  ...
  protected void drawPath(Canvas canvas, List<Float> points, Paint paint, boolean circular,int startIndex) {
	  //Log.e("test", "XXXD 1");
    ...
    if(!isMoveOut){
    	float x1=points.get(0);
    	float x2=points.get(points.size()-2);
    	if(x1<50 && x2>width-50){
    		isMoveOut = true;
    	}
    }*/
  ...
  /* float x1=points.get(0);
    float x2=points.get(points.size()-2);
    Log.e("test", points.size()+"  "+x1+" && "+x2);
    if(x1>width/2 || x2<width/2){
    	isMoveOut = false;
    }*/
    ...
    //Log.e("test", points.get(0)+"_"+points.get(1)+"_"+points.get(2)+"_"+points.get(3));
