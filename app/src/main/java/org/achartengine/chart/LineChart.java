...
public class LineChart extends XYChart {
  ...
  public LineChart(Context context, boolean isWeight, XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer) {
	  super(context,isWeight,dataset, renderer);
	  mContext=context;
	  this.isWeight = isWeight;
    pointsChart = new ScatterChart(context,isWeight,dataset, renderer);
  }
  ...
  protected void setDatasetRenderer(XYMultipleSeriesDataset dataset,
    ...
    pointsChart = new ScatterChart(mContext,isWeight
    		,dataset, renderer);
  }
  ...
  public void drawSeries(Canvas canvas, Paint paint, List<Float> points,
    ...
    for (FillOutsideLine fill : fillOutsideLine) {
      if (fill.getType() != FillOutsideLine.Type.NONE) {
        ...
        //Log.e("test", "$$$$$$$$$ "+points.size());
        paint.setStyle(Style.FILL);
        drawPath(canvas, fillPoints, paint, true,startIndex);
      }
    }
    paint.setColor(renderer.getColor());
    paint.setStyle(Style.STROKE);
    //Log.e("test", "LineChart drawPath    ");
    drawPath(canvas, points, paint, false,startIndex);
