...
public class ChartFactory {
   ...
   *           series
   */
  public static final GraphicalView getLineChartView(Context context, boolean isWeight,
                                                     XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer) {
    checkParameters(dataset, renderer);
    XYChart chart = new LineChart(context,isWeight,dataset, renderer);
   ...
   *           series
   */
  public static final GraphicalView getCubeLineChartView(Context context, boolean isWeight,
                                                         XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, float smoothness) {
    checkParameters(dataset, renderer);
    XYChart chart = new CubicLineChart(context,isWeight,dataset, renderer, smoothness);
    return new GraphicalView(context, chart);
  }
   ...
   *           series
   */
  public static final GraphicalView getScatterChartView(Context context, boolean isWeight,
                                                        XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer) {
    checkParameters(dataset, renderer);
    XYChart chart = new ScatterChart(context,isWeight,dataset, renderer);
    return new GraphicalView(context, chart);
  }
   ...
   *           series
   */
  public static final GraphicalView getBubbleChartView(Context context, boolean isWeight,
                                                       XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer) {
    checkParameters(dataset, renderer);
    XYChart chart = new BubbleChart(context,isWeight,dataset, renderer);
    return new GraphicalView(context, chart);
  }
   ...
   *           series
   */
  public static final GraphicalView getTimeChartView(Context context, boolean isWeight,
                                                     XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, String format, DateChangeCallback callback) {
    checkParameters(dataset, renderer);
    TimeChart chart = new TimeChart(context,isWeight,dataset, renderer,callback);
   ...
   *           series
   */
  public static final GraphicalView getBarChartView(Context context, boolean isWeight,
                                                    XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, Type type) {
    checkParameters(dataset, renderer);
    XYChart chart = new BarChart(context,isWeight,dataset, renderer, type);
    return new GraphicalView(context, chart);
  }
   ...
   *           series
   */
  public static final GraphicalView getRangeBarChartView(Context context, boolean isWeight,
                                                         XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, Type type) {
    checkParameters(dataset, renderer);
    XYChart chart = new RangeBarChart(context,isWeight,dataset, renderer, type);
    return new GraphicalView(context, chart);
  }
   ...
   */
  public static final GraphicalView getCombinedXYChartView(Context context, boolean isWeight,
    ...
    checkParameters(dataset, renderer);
    CombinedXYChart chart = new CombinedXYChart(context,isWeight,dataset, renderer, types);
    return new GraphicalView(context, chart);
  }
   ...
   *           series
   */
  public static final Intent getLineChartIntent(Context context, boolean isWeight,XYMultipleSeriesDataset dataset,
      XYMultipleSeriesRenderer renderer) {
    return getLineChartIntent(context,isWeight, dataset, renderer, "");
  }
   ...
   *           series
   */
  public static final Intent getCubicLineChartIntent(Context context, boolean isWeight,
                                                     XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, float smoothness) {
    return getCubicLineChartIntent(context,isWeight, dataset, renderer, smoothness, "");
  }
   ...
   *           series
   */
  public static final Intent getScatterChartIntent(Context context, boolean isWeight,
                                                   XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer) {
    return getScatterChartIntent(context, isWeight,dataset, renderer, "");
  }
   ...
   *           series
   */
  public static final Intent getBubbleChartIntent(Context context,boolean isWeight, XYMultipleSeriesDataset dataset,
      XYMultipleSeriesRenderer renderer) {
    return getBubbleChartIntent(context,isWeight, dataset, renderer, "");
  }
   ...
   *           series
   */
  public static final Intent getTimeChartIntent(Context context, boolean isWeight, XYMultipleSeriesDataset dataset,
                                                XYMultipleSeriesRenderer renderer, String format, DateChangeCallback callback) {
    return getTimeChartIntent(context, isWeight,dataset, renderer, format, "",callback);
  }
   ...
   *           series
   */
  public static final Intent getBarChartIntent(Context context, boolean isWeight, XYMultipleSeriesDataset dataset,
                                               XYMultipleSeriesRenderer renderer, Type type) {
    return getBarChartIntent(context,isWeight, dataset, renderer, type, "");
  }
   ...
   */
  public static final Intent getTimeChartIntent(Context context, boolean isWeight, XYMultipleSeriesDataset dataset,
                                                XYMultipleSeriesRenderer renderer, String format, String activityTitle, DateChangeCallback callback) {
    checkParameters(dataset, renderer);
    Intent intent = new Intent(context, GraphicalActivity.class);
    TimeChart chart = new TimeChart(context,isWeight,dataset, renderer,callback);
    chart.setDateFormat(format);
  ...
  public static final Intent getBarChartIntent(Context context, boolean isWeight, XYMultipleSeriesDataset dataset,
    ...
    checkParameters(dataset, renderer);
    Intent intent = new Intent(context, GraphicalActivity.class);
    BarChart chart = new BarChart(context,isWeight,dataset, renderer, type);
    intent.putExtra(CHART, chart);
    intent.putExtra(TITLE, activityTitle);
    return intent;
  }
   ...
   *           series
   */
  public static final Intent getRangeBarChartIntent(Context context, boolean isWeight,
                                                    XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, Type type,
                                                    String activityTitle) {
    checkParameters(dataset, renderer);
    Intent intent = new Intent(context, GraphicalActivity.class);
    RangeBarChart chart = new RangeBarChart(context,isWeight,dataset, renderer, type);
    intent.putExtra(CHART, chart);
    intent.putExtra(TITLE, activityTitle);
    return intent;
  }
   ...
   *           series renderers or number of chart types
   */
  public static final Intent getCombinedXYChartIntent(Context context, boolean isWeight,
                                                      XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, String[] types,
                                                      String activityTitle) {
    if (dataset == null || renderer == null || types == null
        || dataset.getSeriesCount() != types.length) {
