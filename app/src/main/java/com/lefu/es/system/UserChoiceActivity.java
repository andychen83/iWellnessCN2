...
public class UserChoiceActivity extends Activity {
    ...
    public static Intent creatIntent(Context context, Records records){
        Intent intent = new Intent(context,UserChoiceActivity.class);
    ...
    public void initAdapter(){
        try {
            ...
            //设置适配器
            mAdapter = new AdultGalleryAdapter(this, mDatas);
            mAdapter.setOnItemClickLitener(new AdultGalleryAdapter.OnItemClickLitener()
            {
                @Override
    ...
    @OnClick(R.id.addBtn)
    public  void addUser(){
        startActivityForResult(AdultAddActivity.creatIntent(UserChoiceActivity.this,records),104);
    }
