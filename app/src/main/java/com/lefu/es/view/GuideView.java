...
/**
 * Created by andychen on 2016/1/23.
 * 
 *       GuideView.Builder
...
//        return mContent.getSharedPreferences(TAG, Context.MODE_PRIVATE).getBoolean(generateUniqId(targetView), false);
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (backgroundColor != 0){
            ...
            bgPaint.setColor(getResources().getColor(R.color.transparent));
        }
     ...
     // 绘制屏幕背景
        ...
        Shader mShader = new RadialGradient(center[0], center[1], radius,new int[] {Color.WHITE,Color.WHITE,Color.WHITE,Color.parseColor("#aa222222")},null,Shader.TileMode.REPEAT);    
   ...
   public enum MyShape {
    ...
    public void setCustomViewOnclickListener(final View.OnClickListener callback) {
    	customGuideView.setOnClickListener(callback);
    }
    ...
    public static class Builder {
        ...
        public static Builder newInstance(Context ctx) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(200, 400);
