...
public class DiseaseAutoCompleteTextView extends AutoCompleteTextView implements OnFocusChangeListener  {
	...
	public DiseaseAutoCompleteTextView(Context context, AttributeSet attrs,
			int defStyle) {
...
//		init();
	...
	private void init() {
		//setThreshold为1表示输入一个字符就开始自动提示，系统默认的是2，即输入两个有提示
		setThreshold(1); 
    ...
    public interface InputStatu{
        void onInput(boolean b);
    }
    
    public void setInputStatu(InputStatu inputStatu){
        this.inputStatu = inputStatu;
    }
