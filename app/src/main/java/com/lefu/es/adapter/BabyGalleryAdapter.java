...
public class BabyGalleryAdapter extends  RecyclerView.Adapter<BabyGalleryAdapter.ViewHolder> {
    ...
    public BabyGalleryAdapter(Context context, List<UserModel> datats)
    {
    ...
    {
        View view = mInflater.inflate(R.layout.item_baby_select,
                viewGroup, false);
